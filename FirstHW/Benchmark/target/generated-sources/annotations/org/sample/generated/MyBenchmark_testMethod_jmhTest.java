...
import org.sample.generated.MyBenchmark_State1_jmhType;
public final class MyBenchmark_testMethod_jmhTest {
    ...
    public BenchmarkTaskResult testMethod_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            MyBenchmark_State1_jmhType l_state11_1 = _jmh_tryInit_f_state11_1(control);
            ...
            while (control.warmupShouldWait) {
                l_state11_1.prepare();
                blackhole.consume(l_mybenchmark0_0.testMethod(l_state11_1));
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            testMethod_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_state11_1, l_mybenchmark0_0);
    ...
    public static void testMethod_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, MyBenchmark_State1_jmhType l_state11_1, MyBenchmark_jmhType l_mybenchmark0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult testMethod_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            testMethod_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_state11_1, l_mybenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult testMethod_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            testMethod_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_state11_1, l_mybenchmark0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void testMethod_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, MyBenchmark_State1_jmhType l_state11_1, MyBenchmark_jmhType l_mybenchmark0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult testMethod_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            testMethod_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_state11_1, l_mybenchmark0_0);
            control.preTearDown();
    ...
    public static void testMethod_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, MyBenchmark_State1_jmhType l_state11_1, MyBenchmark_jmhType l_mybenchmark0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    MyBenchmark_State1_jmhType f_state11_1;
    
    MyBenchmark_State1_jmhType _jmh_tryInit_f_state11_1(InfraControl control) throws Throwable {
        if (control.isFailing) throw new FailureAssistException();
        MyBenchmark_State1_jmhType val = f_state11_1;
        if (val == null) {
            val = new MyBenchmark_State1_jmhType();
                Field f;
                f = org.sample.MyBenchmark.State1.class.getDeclaredField("s");
                f.setAccessible(true);
                f.set(val, control.getParam("s"));
                f = org.sample.MyBenchmark.State1.class.getDeclaredField("threadsCount");
                f.setAccessible(true);
                f.set(val, Integer.valueOf(control.getParam("threadsCount")));
            f_state11_1 = val;
        }
        return val;
    }
